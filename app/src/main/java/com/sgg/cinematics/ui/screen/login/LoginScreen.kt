...
import com.sgg.cinematics.ui.commonui.TextFieldVariant
    ...
    Box {
        ...
        Column(modifier = modifier
            ...
            PasswordTextFieldWrapper(
                    ...
                    textFieldVariant = TextFieldVariant.FILLED,
                    isError = false,
...
fun SinInSignUpButton(
    ...
    Button(enabled = isLoginButtonEnabled,
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp),
            ...
            Icon(tint = md_theme_light_onSecondary,
    ...
    Button(onClick = { },
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp),
            ...
            Image(painter = painterResource(id = R.drawable.icon_gmail),
